...
return c[b(c.length/2)]}}export function histogram(a){if(!isArray(a))return;let b={};return a.forEach(a=>{b[a]=(b[a]||0)+1}),b;/* Or:
	...
	*/}export function mode(a){const b=histogram(a);return Object.keys(b).reduce((a,c)=>(b[c]>a.count&&(a={element:c,count:b[c]}),a),{element:void 0,count:0})}
